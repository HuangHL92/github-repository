...
import com.ruoyi.wx.mp.handler.*;
...
public class WxMpConfiguration {
    ...
    private static Map<String, WxService> mpServices = Maps.newHashMap();
    ...
    public static Map<String, WxService> getMpServices() {
        return mpServices;
    }
    ...
    public void initServices() {
        ...
        mpServices = configs.stream().map(a -> {
            ...
            configStorage.setWebPath(a.getWebPath());
            configStorage.setThirdUrl(a.getThirdUrl());
    ...
    private WxMpMessageRouter newRouter(WxService wxMpService) {
