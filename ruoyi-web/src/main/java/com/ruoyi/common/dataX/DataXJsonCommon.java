package com.ruoyi.common.dataX;

import cn.hutool.core.io.FileUtil;
import cn.hutool.json.JSONUtil;
import com.ruoyi.area.dataX.domain.DsonJobIn;
import com.ruoyi.common.config.Global;
import com.ruoyi.common.dataX.dType.DsonJob;
import com.ruoyi.common.jsonIO.ExportJson;
...
public class DataXJsonCommon {
     ...
     * datax的python文件地址
     */
    public static String DATAX_PATH = "./ruoyi-web/src/main/java/com/ruoyi/common/dataX/bin/datax.py";
    /**
     * dataX log文件夹路径
     */
    ...
    public static String exeDataX(String fileName) {
        try {
             ...
             * 执行Python命令
             */
            String windowCmd = "python27" + " " + "./ruoyi-web/src/main/java/com/ruoyi/common/dataX/bin/datax.py" + " " + JSON_PATH + fileName + ".json";
    ...
    public static void exeDataxs() {
        try {
            ...
            for (String name : str) {
                String windowcmd = "python27" + " " + DATAX_PATH + " " + JSON_PATH + "/" + name + ".json";
